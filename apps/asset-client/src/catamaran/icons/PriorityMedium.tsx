...
function PriorityMediumIcon(props: Props) {
  return (
    <IconBase {...props} fill="none" height={24} width={24}>
      ...
      <path
        d="M9.93 7.741a1.881 1.881 0 1 1 3.74 0l-.705 6.388a1.172 1.172 0 0 1-2.33 0L9.93 7.741Z"
        fill="currentColor"
      />
      <ellipse cx={11.8} cy={17.289} fill="currentColor" rx={1.05} ry={1.058} />
    </IconBase>
  );
}
